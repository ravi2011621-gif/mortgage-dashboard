...
const CURATED_LENDERS = [
  { id: "uwm", lender: "United Wholesale Mortgage (UWM)", rateAdj: -0.06, aprAdj: -0.01, fees: 3200, points: 0.45, style: "Wholesale pricing" },
  { id: "rocket", lender: "Rocket Mortgage", rateAdj: 0.06, aprAdj: 0.11, fees: 2500, points: 0.12, style: "Convenience" },
  { id: "loandepot", lender: "loanDepot", rateAdj: 0.02, aprAdj: 0.07, fees: 3300, points: 0.42, style: "Balanced" },
  { id: "pennymac", lender: "Pennymac", rateAdj: -0.01, aprAdj: 0.04, fees: 3100, points: 0.38, style: "Aggressive retail" },
  { id: "newrez", lender: "NewRez", rateAdj: 0.01, aprAdj: 0.05, fees: 3400, points: 0.44, style: "Balanced" },
  { id: "bofa", lender: "Bank of America", rateAdj: 0.03, aprAdj: 0.08, fees: 2900, points: 0.31, style: "Bank relationship" },
  { id: "chase", lender: "JPMorgan Chase", rateAdj: 0.02, aprAdj: 0.07, fees: 3300, points: 0.36, style: "Bank relationship" },
  { id: "wells", lender: "Wells Fargo", rateAdj: 0.04, aprAdj: 0.08, fees: 3000, points: 0.34, style: "Branch network" },
  { id: "navyfed", lender: "Navy Federal", rateAdj: -0.03, aprAdj: 0.01, fees: 3100, points: 0.42, style: "Member value" },
  { id: "guild", lender: "Guild Mortgage", rateAdj: 0.00, aprAdj: 0.05, fees: 3600, points: 0.49, style: "Balanced" },
  { id: "crosscountry", lender: "CrossCountry Mortgage", rateAdj: 0.03, aprAdj: 0.09, fees: 3900, points: 0.61, style: "Retail network" },
  { id: "fairway", lender: "Fairway Mortgage", rateAdj: 0.01, aprAdj: 0.07, fees: 3700, points: 0.55, style: "Service-heavy" },
  { id: "veteransunited", lender: "Veterans United", rateAdj: -0.02, aprAdj: 0.03, fees: 3000, points: 0.35, style: "VA-focused" },
  { id: "usbank", lender: "U.S. Bank", rateAdj: 0.03, aprAdj: 0.08, fees: 3200, points: 0.37, style: "Bank relationship" },
  { id: "amerihome", lender: "Amerihome Mortgage", rateAdj: -0.01, aprAdj: 0.04, fees: 3500, points: 0.47, style: "Competitive pricing" },
  { id: "citi", lender: "CitiMortgage", rateAdj: 0.04, aprAdj: 0.08, fees: 3100, points: 0.33, style: "Bank relationship" },
  { id: "cmg", lender: "CMG Mortgage", rateAdj: 0.00, aprAdj: 0.06, fees: 3600, points: 0.52, style: "Balanced" },
  { id: "dhi", lender: "DHI Mortgage", rateAdj: 0.05, aprAdj: 0.10, fees: 2800, points: 0.22, style: "Builder captive" },
  { id: "freedom", lender: "Freedom Mortgage", rateAdj: -0.01, aprAdj: 0.04, fees: 3400, points: 0.41, style: "Refi-friendly" },
  { id: "lennar", lender: "Lennar Mortgage", rateAdj: 0.05, aprAdj: 0.10, fees: 2800, points: 0.24, style: "Builder captive" },
  { id: "mrcooper", lender: "Mr. Cooper", rateAdj: 0.01, aprAdj: 0.06, fees: 3500, points: 0.46, style: "Servicer advantage" },
  { id: "planet", lender: "Planet Home Lending", rateAdj: 0.00, aprAdj: 0.05, fees: 3450, points: 0.43, style: "Balanced" },
  { id: "rate", lender: "Rate", rateAdj: 0.02, aprAdj: 0.07, fees: 3300, points: 0.39, style: "Retail scale" },
  { id: "truist", lender: "Truist Mortgage", rateAdj: 0.03, aprAdj: 0.08, fees: 3200, points: 0.36, style: "Bank relationship" },
];
...
const FOMC_MEETINGS = [
  {
    ...
    keyPoints: [
      "Fed slowed the pace of hikes but kept tightening bias.",
      "Inflation acknowledged as easing, but still too high.",
      "Labor market remained very tight.",
    ],
    summary:
      "The Fed raised rates by 25 basis points and signaled that additional increases were still likely. Markets initially focused on the slower pace, but the underlying message remained restrictive.",
    mortgageView:
      "Mortgage-negative overall. Even with a smaller hike, the Fed kept the ceiling elevated for long-end rates and delayed hopes for broad mortgage relief.",
  },
  {
    date: "2023-03-21",
    ...
    keyPoints: [
      "Decision came during regional bank stress.",
      "Fed balanced inflation risk against financial stability concerns.",
      "Forward guidance softened slightly.",
    ],
    summary:
      "The Fed raised rates while acknowledging tighter credit conditions from banking stress. Markets interpreted the meeting as less hawkish than prior ones, but uncertainty rose sharply.",
    mortgageView:
      "Volatility-positive but directionally mixed. Mortgage rates became more sensitive to risk sentiment and spread behavior rather than just Fed policy levels.",
  },
  {
    date: "2023-07-25",
    ...
    keyPoints: [
      "Fed lifted rates to cycle highs.",
      "Inflation still above target despite progress.",
      "Policy described as data dependent.",
    ],
    summary:
      "The Fed delivered another quarter-point increase and preserved a restrictive stance. Markets understood that rates would stay high until inflation clearly normalized.",
    mortgageView:
      "Kept mortgage affordability under pressure by supporting elevated Treasury yields and limiting expectations for near-term easing.",
  },
  {
    date: "2024-03-19",
    ...
    keyPoints: [
      ...
      "Disinflation progress noted but not declared complete.",
      "Markets looked for signals on future cuts.",
    ],
    summary:
      "The committee kept rates unchanged and maintained a cautious tone. The message was that lower rates would require sustained proof from inflation data, not just optimism.",
    mortgageView:
  ...
  },
  {
    ...
    keyPoints: [
      "Focus shifted toward growth slowdown risk.",
      "Guidance mattered more than the hold itself.",
      "Treasury reaction drove mortgage repricing.",
    ],
    summary:
      "Markets focused on whether slowing growth would justify a softer future path. The Fed remained careful, but long-end yields moved mostly on interpretation rather than the actual policy move.",
    mortgageView:
      "Mortgage pricing became more expectation-driven, with Treasury yields doing most of the directional work.",
  },
  {
    date: "2025-03-18",
    ...
    keyPoints: [
      "Inflation progress remained uneven.",
      "Fed did not want to over-commit to cuts.",
      "Labor conditions still resilient.",
    ],
    summary:
      "The Fed held steady and emphasized that inflation progress remained uneven. Markets stayed cautious because the policy path still depended heavily on incoming inflation and labor data.",
    mortgageView:
      "Preserved lender pricing discipline while limiting immediate mortgage relief for borrowers.",
  },
  {
    date: "2025-12-09",
    label: "Dec 9-10, 2025",
    ...
    keyPoints: [
      "Year-end guidance shaped next-year expectations.",
      "Markets focused on the pace of future easing.",
      "Inflation durability remained a question.",
    ],
    summary:
      "Year-end guidance mattered more than the hold itself. Mortgage markets watched closely for clues on the coming year's easing path and the stability of inflation improvement.",
    mortgageView:
      "Important for lock behavior and forward pricing expectations into the new year.",
  },
  {
    date: "2026-01-27",
    ...
    keyPoints: [
      "Inflation still not fully back to target.",
      "Fed stayed cautious despite better disinflation.",
      "Markets pushed back expectations for rapid easing.",
    ],
    summary:
      "The Fed held rates steady and emphasized that inflation was still not fully back to target. Markets read the tone as cautious and restrictive.",
    mortgageView:
      "Mortgage-negative tone because it preserved higher-for-longer expectations and kept long-end yields sticky.",
  },
  {
    date: "2026-03-17",
    ...
    keyPoints: [
      ...
      "Fed maintained restrictive messaging.",
      "Treasury yields moved up after the meeting.",
    ],
    summary:
      "The committee left rates unchanged but stressed upside inflation risks. That reinforced a higher-for-longer tone and contributed to upward pressure on mortgage coupons.",
    mortgageView:
      "Raised the risk of higher mortgage coupons through both benchmark yields and market sentiment.",
  },
  {
    date: "2026-04-28",
    ...
    targetRange: "TBD",
    keyPoints: [
      "Focus likely on inflation trajectory.",
      "Growth slowdown will matter more if labor weakens.",
      "Markets will listen for tone more than action.",
    ],
    summary:
      "This meeting is expected to focus on whether inflation is cooling enough to justify a softer policy path. Markets will watch the statement and press conference carefully.",
    mortgageView:
  ...
  },
  {
    ...
    targetRange: "TBD",
    keyPoints: [
      "Could become an inflection window.",
      "Labor and inflation data will decide tone.",
      "Refi psychology would respond quickly to dovish language.",
    ],
    summary:
      "This is viewed as a possible inflection window if inflation and labor data continue to soften. Any change in the projected path of rates could ripple quickly through mortgage pricing.",
    mortgageView:
      "A softer tone here would likely matter more for refinance psychology than immediate purchase affordability.",
  },
];
...
const fallbackSeries = Array.from({ length: 260 }).map((_, i) => {
  ...
  return {
    ...
    heloc: +(conforming30 + 1.5).toFixed(2),
    treasury10,
    treasury2,
...
function effective5YearCost(loanAmount, rate, fees, termYears) {
...
function SimpleCard({ children, style = {} }) {
  return (
    <div
      style={{
        borderRadius: 24,
...
function buildAnalysis(series) {
  ...
  const mortgageSpread = latest.mortgageSpread ?? null;
  const previousSpread = prior.mortgageSpread ?? null;
  ...
  const factors = [
    ...
    },
    {
      ...
      score:
        mortgageSpread != null ? Math.max(38, Math.min(84, Math.round(mortgageSpread * 18))) : 56,
...
function buildLenderIntelligence(series, scenario, sortBy) {
  ...
  const rows = CURATED_LENDERS.map((item) => {
    ...
    const effectiveCost = effective5YearCost(loanAmount, rate, item.fees, scenario.termYears);
  ...
  const ranked = rows.map((row) => ({
    ...
    bestFor:
      row.fees < 3000
        ? "Low upfront cost"
        : row.deltaVsMarket <= -0.04
        ? "Low note rate"
        : row.payment != null && row.payment < ((rows[0]?.payment ?? Infinity) + 25)
        ? "Low payment"
        : "Balanced option",
  }));
  ...
  return {
    ...
    rows: sorted,
    topCost: byCost[0],
    topRate: [...ranked].sort((a, b) => a.rate - b.rate)[0],
  };
}

function buildVolumeIntelligence(series, betterRate) {
  const latest = series.at(-1) ?? {};
  const prior = series.at(-5) ?? series.at(0) ?? {};
  ...
  return {
    ...
    explanation:
      total >= 20
        ? "Lower or stabilizing rates, stronger pricing position, and better refinance economics support stronger volume."
        : total >= 0
        ? "Signals are mixed. Volume may hold, but gains depend on competitive pricing and borrower response."
        : "Either rates are not helping demand, Better is not strongly positioned, or macro conditions are reducing borrower urgency.",
  };
}
      ...
      {range === "custom" ? (
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
          <input
            ...
            style={{ borderRadius: 12, border: "1px solid #cbd5e1", padding: "10px 12px", fontSize: 14 }}
          />
...
function HeatBar({ value, color = "#0f172a" }) {
  return (
    <div
      style={{
        height: 8,
...
export default function Page() {
  ...
  const [betterOffset, setBetterOffset] = React.useState(0.0);
  ...
  React.useEffect(() => {
    ...
    async function loadLive() {
      try {
        ...
        const longestRange =
          ["15y", "10y", "5y", "3y", "1y", "6m"].find((key) =>
            [chartRanges.rates, chartRanges.macro, chartRanges.spread, chartRanges.yields].includes(key)
          ) || "5y";
  ...
  const lenderIntel = React.useMemo(
    () => buildLenderIntelligence(series, scenario, lenderSort),
    [series, scenario, lenderSort]
  );

  const betterRate = React.useMemo(() => {
    const market = series.at(-1)?.conforming30 ?? 6.25;
    return +(market + betterOffset).toFixed(3);
  }, [series, betterOffset]);

  const volumeIntel = React.useMemo(
    () => buildVolumeIntelligence(series, betterRate),
    [series, betterRate]
  );
  ...
  const ratesSeries = React.useMemo(
    () =>
      densifySeries(
        ...
        ["conforming30", "conforming15", "fha30", "va30", "jumbo30", "heloc"]
      ),
  ...
  const macroSeries = React.useMemo(
    () =>
      densifySeries(
        ...
        ["fedFunds", "inflationYoY", "unemployment"]
      ),
  ...
  const spreadSeries = React.useMemo(
    () =>
      densifySeries(
        filterSeriesByRange(series, chartRanges.spread, customRanges.spread),
        ["mortgageSpread", "curveSpread"]
      ),
    [series, chartRanges.spread, customRanges.spread]
  );

  const yieldsSeries = React.useMemo(
    () =>
      densifySeries(
        filterSeriesByRange(series, chartRanges.yields, customRanges.yields),
        ["treasury10", "treasury2"]
      ),
    [series, chartRanges.yields, customRanges.yields]
  );
      ...
      >
            ...
            >
              <div>
                ...
                <p style={{ marginTop: 10, marginBottom: 0, fontSize: 15, color: "#64748b" }}>
                  Live benchmark rates and macro series, plus lender intelligence and volume outlook.
                </p>
              </div>
        ...
        <SimpleCard>
          <SectionHeader
            ...
            description="Estimate how rate moves and Better pricing position may influence volume"
          ...
          <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#f0fdf4", padding: 18 }}>
                <div style={{ fontSize: 12, color: "#166534" }}>Volume outlook</div>
                <div style={{ marginTop: 8, fontSize: 30, fontWeight: 800, color: volumeIntel.tone }}>{volumeIntel.signal}</div>
                <div style={{ marginTop: 6, fontSize: 13, color: "#475569" }}>{volumeIntel.explanation}</div>
              </motion.div>

              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#eff6ff", padding: 18 }}>
                <div style={{ fontSize: 12, color: "#1d4ed8" }}>Better pricing vs market</div>
              ...
              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#fff7ed", padding: 18 }}>
                <div style={{ fontSize: 12, color: "#c2410c" }}>Volume score</div>
                <div style={{ marginTop: 8, fontSize: 30, fontWeight: 800 }}>{volumeIntel.total}</div>
                <div style={{ marginTop: 6, fontSize: 13, color: "#475569" }}>
                  Demand {volumeIntel.demand} / Pricing {volumeIntel.pricing} / Refi {volumeIntel.refi} / Macro {volumeIntel.macro}
                </div>
              </motion.div>

              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#faf5ff", padding: 18 }}>
        ...
        <SimpleCard>
          <SectionHeader
            ...
            description="Dynamic comparison layer built on the live market benchmark and your selected quote scenario"
          ...
          <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 12, color: "#64748b", marginBottom: 6 }}>Sort by</div>
                <select
                  value={lenderSort}
                ...
                >
                  ...
                  <option value="cost">5Y effective cost</option>
                </select>
              </div>
            </div>
            ...
            >
              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#f8fafc", padding: 16 }}>
                <div style={{ fontSize: 12, color: "#64748b" }}>Scenario loan amount</div>
                <div style={{ marginTop: 8, fontSize: 28, fontWeight: 800 }}>{formatDollar(lenderIntel.loanAmount)}</div>
              </motion.div>

              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#f8fafc", padding: 16 }}>
                <div style={{ fontSize: 12, color: "#64748b" }}>Market benchmark</div>
                <div style={{ marginTop: 8, fontSize: 28, fontWeight: 800 }}>{formatPct(lenderIntel.marketRate)}</div>
              </motion.div>

              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#f8fafc", padding: 16 }}>
                <div style={{ fontSize: 12, color: "#64748b" }}>Best overall cost</div>
                <div style={{ marginTop: 8, fontSize: 22, fontWeight: 800 }}>{lenderIntel.topCost?.lender ?? "—"}</div>
                <div style={{ marginTop: 4, fontSize: 12, color: "#64748b" }}>
                  {formatDollar(lenderIntel.topCost?.effectiveCost)} over 5Y
                </div>
              </motion.div>

              <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#f8fafc", padding: 16 }}>
                <div style={{ fontSize: 12, color: "#64748b" }}>Lowest note rate</div>
                <div style={{ marginTop: 8, fontSize: 22, fontWeight: 800 }}>{lenderIntel.topRate?.lender ?? "—"}</div>
                <div style={{ marginTop: 4, fontSize: 12, color: "#64748b" }}>
                  {formatPct(lenderIntel.topRate?.rate)}
                </div>
              </motion.div>
            </div>
            ...
            <div style={{ overflowX: "auto", border: "1px solid #e2e8f0", borderRadius: 18 }}>
              <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 1120 }}>
                <thead style={{ background: "#f8fafc" }}>
                  <tr>
                    {["Lender", "Product", "Rate", "APR", "Payment", "Fees", "Δ vs Market", "Cost Rank", "Best For", "Updated"].map((h) => (
                      <th
                        key={h}
                        style={{
                          textAlign: "left",
            ...
            <div style={{ fontSize: 12, color: "#64748b" }}>
              This lender section is dynamic against the live market benchmark and user scenario. Individual lender rows are curated model outputs, not a full live lender marketplace feed.
            </div>
          </div>
        </SimpleCard>
        ...
        <section id="rates" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{ width: "100%", height: 420 }}>
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={ratesSeries}>
                      ...
                      <YAxis tickFormatter={(value) => `${Number(value).toFixed(1)}%`} domain={["dataMin - 0.1", "dataMax + 0.1"]} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1.5fr) minmax(320px, 1fr)", gap: 16 }}>
            <SimpleCard>
              <SectionHeader
                title="Treasury yields and curve"
                description="10Y, 2Y, and curve spread over time"
                icon={<CircleDollarSign size={18} />}
              />
              <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 16 }}>
                <ChartRangeControls
                  range={chartRanges.yields}
                  setRange={(value) => setChartRanges((prev) => ({ ...prev, yields: value }))}
                  customRange={customRanges.yields}
                  setCustomRange={(value) =>
                    setCustomRanges((prev) => ({
                      ...prev,
                      yields: typeof value === "function" ? value(prev.yields) : value,
                    }))
                  }
                />
                {yieldsSeries.length ? (
                  <div style={{ width: "100%", height: 420 }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={yieldsSeries}>
                        ...
                        <Line type="monotone" dataKey="curveSpread" name="10Y-2Y Curve Spread" stroke={getSeriesColor("curveSpread")} strokeWidth={2.5} dot={false} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                ) : (
            ...
            <SimpleCard>
              ...
              <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 16 }}>
                {analysis.factors.map((factor) => (
                  <div key={factor.name}>
                    <div style={{ marginBottom: 8, display: "flex", justifyContent: "space-between", gap: 10, fontSize: 14 }}>
                      <span style={{ fontWeight: 600, color: "#334155" }}>{factor.name}</span>
                      <span style={{ color: "#64748b" }}>{factor.score}/100</span>
                    </div>
                    <HeatBar value={factor.score} color={factor.score >= 65 ? "#dc2626" : factor.score >= 50 ? "#d97706" : "#0f766e"} />
                  </div>
                ))}
              </div>
            </SimpleCard>
        ...
        <section id="macro" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1.1fr) minmax(0, 0.9fr)", gap: 16 }}>
            <SimpleCard>
              <SectionHeader
                title="Macro Factors"
                description="Fed funds, inflation, and unemployment"
                  ...
                  <div style={{ width: "100%", height: 420 }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={macroSeries}>
                        ...
                        <Tooltip formatter={(value) => formatPct(value)} />
                        <Legend />
                        <Line type="monotone" dataKey="fedFunds" name="Fed Funds" stroke={getSeriesColor("fedFunds")} strokeWidth={3} dot={false} />
            ...
            <SimpleCard>
              <SectionHeader
                ...
                description="Current spread and historical pattern"
              />
              <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 16 }}>
                <ChartRangeControls
                    ...
                    <div style={{ width: "100%", height: 250 }}>
                      <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={spreadSeries}>
                          ...
                          <Area type="monotone" dataKey="mortgageSpread" name="Mortgage Spread" stroke={getSeriesColor("mortgageSpread")} fill={getSeriesColor("mortgageSpread")} fillOpacity={0.22} strokeWidth={3} />
                        </AreaChart>
                      </ResponsiveContainer>
                    </div>
                    <div style={{ width: "100%", height: 150 }}>
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={spreadSeries.slice(-12)}>
                          <CartesianGrid strokeDasharray="3 3" vertical={false} />
                          <XAxis dataKey="label" />
                          <YAxis tickFormatter={(value) => `${Number(value).toFixed(1)}%`} />
                          <Tooltip formatter={(value) => formatPct(value)} />
                          <Bar dataKey="curveSpread" name="Curve Spread" fill={getSeriesColor("curveSpread")} radius={[6, 6, 0, 0]} />
                        </BarChart>
                      </ResponsiveContainer>
                    </div>
                  </>
        ...
        <section id="meetings">
          <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1.05fr) minmax(360px, 0.95fr)", gap: 16 }}>
            <SimpleCard>
              <SectionHeader
                title="Fed Meetings"
                description="Past and upcoming meetings with decision and takeaway"
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center" }}>
                          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                            ...
                            <div>
                              ...
                              <div style={{ marginTop: 4, fontSize: 13, color: active ? "#cbd5e1" : "#64748b" }}>{meeting.date}</div>
                            </div>
                          </div>
                          <div
                            style={{
            ...
            <SimpleCard>
              <SectionHeader
                ...
                description="Decision summary, key points, and mortgage interpretation"
              />
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                      <div style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#ffffff", padding: 14 }}>
                        <div style={{ fontSize: 12, color: "#64748b" }}>Rate move</div>
                        <div style={{ marginTop: 6, fontSize: 18, fontWeight: 700 }}>{selectedMeeting?.rateChange}</div>
                      </div>
                      <div style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#ffffff", padding: 14 }}>
                        <div style={{ fontSize: 12, color: "#64748b" }}>Target range</div>
                        <div style={{ marginTop: 6, fontSize: 18, fontWeight: 700 }}>{selectedMeeting?.targetRange}</div>
                      </div>
                    </div>

                    <div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#334155" }}>Policy summary</div>
                      <p style={{ marginTop: 8, fontSize: 14, lineHeight: 1.7, color: "#334155" }}>{selectedMeeting?.summary}</p>
                    </div>

                    <div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#334155" }}>Key points</div>
                      <ul style={{ marginTop: 8, paddingLeft: 20, color: "#334155" }}>
                        {selectedMeeting?.keyPoints?.map((point) => (
                          <li key={point} style={{ marginBottom: 8, lineHeight: 1.6 }}>
                            {point}
                          </li>
                        ))}
                      </ul>
                    ...
                    <div style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#ffffff", padding: 16 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#334155" }}>Mortgage interpretation</div>
                      <p style={{ marginTop: 8, fontSize: 14, lineHeight: 1.7, color: "#334155" }}>{selectedMeeting?.mortgageView}</p>
                    </div>
                  </motion.div>
                </AnimatePresence>
              </div>
          ...
          <SimpleCard>
            ...
            <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
                <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#eff6ff", padding: 20 }}>
                ...
                <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#fef3c7", padding: 20 }}>
                  ...
                  <p style={{ marginTop: 10, fontSize: 14, lineHeight: 1.6, color: "#475569" }}>{analysis.shortCall}</p>
                </motion.div>

                <motion.div whileHover={{ y: -3 }} style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#fff7ed", padding: 20 }}>
                  <div style={{ fontSize: 14, color: "#64748b" }}>Mortgage spread</div>
                  <div style={{ marginTop: 8, fontSize: 36, fontWeight: 800 }}>{formatPct(analysis.mortgageSpread)}</div>
              ...
              <div style={{ borderRadius: 24, border: "1px solid #e2e8f0", background: "#ffffff", padding: 20 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
                {analysis.factors.map((factor) => (
                  <motion.div
                    whileHover={{ y: -3 }}
                    key={factor.name}
                    style={{ borderRadius: 18, border: "1px solid #e2e8f0", background: "#ffffff", padding: 16 }}
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center" }}>
